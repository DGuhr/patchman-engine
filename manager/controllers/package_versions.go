...
func packageVersionsQuery(db *gorm.DB, acc int, authzHosts []string, packageNameIDs []int) *gorm.DB {
...
func PackageVersionsListHandler(c *gin.Context) {
	...
	query := packageVersionsQuery(db, account, authzHosts, packageNameIDs)
